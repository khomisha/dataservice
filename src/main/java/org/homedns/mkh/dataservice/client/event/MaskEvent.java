 ...
 * the License.
 *
 * $Id: MaskEvent.java 6 2013-09-09 07:17:19Z khomisha $
 */
 ...
 *
 */
public class MaskEvent extends GenericEvent< MaskEvent.MaskHandler > {
	...
	public static final Event.Type< MaskHandler > TYPE = new Event.Type< MaskHandler >( );

	/**
	 * Fires mask event
	 */
	public static void fire( ) {
		fire( new MaskEvent( ), null );
	}
	 ...
	 */
	@Override
	protected Event.Type< MaskHandler > getType( ) {
		return( TYPE );
	}
